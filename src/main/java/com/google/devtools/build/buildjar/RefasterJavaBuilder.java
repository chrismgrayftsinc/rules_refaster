...
import com.google.errorprone.RefasterErrorPronePlugin;
...
public class RefasterJavaBuilder extends BazelJavaBuilder {


  private static final String CMDNAME = "RefasterJavaBuilder";

  /** The main method of the BazelJavaBuilder. */
  public static void main(String[] args) {
    RefasterJavaBuilder builder = new RefasterJavaBuilder();
  ...
  public JavaLibraryBuildRequest parse(List<String> args)
    ...
    ImmutableList<BlazeJavaCompilerPlugin> plugins = ImmutableList.of(new RefasterErrorPronePlugin());
